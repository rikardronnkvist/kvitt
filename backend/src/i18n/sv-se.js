...
export const oauthMessages = {
  ...
  authorizationRequestExpired: 'Auktoriseringsförfrågan är ogiltig eller har gått ut.',
  authorizationRequestRateLimited: 'För många auktoriseringsförfrågningar. Försök igen senare.',
  authorizationRequestUnavailable: 'Auktoriseringsförfrågan kunde inte sparas. Försök igen.',
  ...
  invalidAuthorizationRequestHandle: 'Auktoriseringsförfrågan är ogiltig.',
